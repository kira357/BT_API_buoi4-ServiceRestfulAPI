...
namespace _5951071014_TranTienDat.Models
{
    public class db
    {
        SqlConnection con = new SqlConnection(@"Data Source=LAPTOP-0II0U9OF\SQLEXPRESS01;Initial Catalog=DemoCRUD;Integrated Security=True");
